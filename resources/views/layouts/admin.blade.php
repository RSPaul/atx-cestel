...
<html lang="en">
   <head>
      ...
      <title>Cestal - Admin | Dashboard</title>
   ...
   <body id="page-top">
      ...
      <div id="wrapper">
         ...
         <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('admin_dashboard') }}">
               ...
               <div class="sidebar-brand-text mx-3"><img style="width: 100px;" src="{{ asset('/img/logo.png') }}"></div>
            </a>
            <!-- Divider -->
            ...
            <footer class="sticky-footer bg-white">
               <div class="container my-auto">
                  <div class="copyright text-center my-auto">
                     <span>Copyright &copy; 2020 The Cesta</span>
                  </div>
               </div>
            </footer>
            <!-- End of Footer -->
      ...
      <!-- <script src="chart/vendor.js/Chart.min.js"></script> -->
